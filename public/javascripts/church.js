// General Map Setup
function initMap() {
    var map = new google.maps.Map(document.getElementById('church'), {
   ...
   placeId: 'ChIJ4wC4knMUuEcRnuCafwrxE78'
    ...
    service.getDetails(
     ...
     placeId: 'ChIJJ9Q0lnMUuEcRl_ZA1_i-df8'
      ...
      service.getDetails(
        {
       placeId: 'ChIJc6GyaHIUuEcRZL8kyhd-5RA'
        }, function(place, status) {
          if (status === google.maps.places.PlacesServiceStatus.OK)
          {
         var iconBase = 'http://retroactivesolutions.com/premadeMapForPool2/';
  ...
  service.getDetails(
    ...
    }, function(place, status)
    {
     ...
     var map;
    var src = 'http://retroactivesolutions.com/premadeMapForPool2/Culture/directionsChurch.kml';

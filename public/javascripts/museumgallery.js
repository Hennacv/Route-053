// General Map Setup
function initMap() {
    var map = new google.maps.Map(document.getElementById('musgal'), {
  ...
  service.getDetails(
    ...
    }, function(place, status)
    {
     ...
     var map;
    var src = 'http://retroactivesolutions.com/premadeMapForPool2/Culture/directionsTheaterGallery.kml';
